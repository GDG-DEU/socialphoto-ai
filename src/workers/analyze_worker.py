    ...
    while not shutdown_event.is_set():
        try:
            ...
            try:
                ...
                is_nsfw = analysis_result["is_nsfw"]
                nsfw_score = analysis_result["scores"].get("nsfw", 0)
                ...
                logger.info(f"Job {job_id} successfully analyzed. Result: {'NSFW' if is_nsfw else 'SAFE'}")
